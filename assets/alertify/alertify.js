        ...
        return {
            ...
            settingUpdated: function (key, oldValue, newValue) {
                ...
                case 'message':
                    ...
                    break;
                case 'labels':
                    if ('موافق' in newValue && this.__internal.buttons[0].element) {
                        this.__internal.buttons[0].text = newValue.ok;
                        this.__internal.buttons[0].element.innerHTML = newValue.ok;
                    }
                    if ('الغاء' in newValue && this.__internal.buttons[1].element) {
                ...
                case 'reverseButtons':
                    ...
                    break;
                case 'defaultFocus':
                    this.__internal.focus.element = newValue === 'موافق' ? 0 : 1;
                    break;
                }
            },
            callback: function (closeEvent) {
